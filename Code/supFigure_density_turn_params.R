...
p_se <- ggplot2::ggplot(splits,
                        ggplot2::aes(x = pracma::rad2deg(ang_vel), y = dist2cent)) +
...
p_s <- ggplot2::ggplot(split_sim, ggplot2::aes(x = abs(ang_vel), y = centr)) +
  ggplot2::stat_density_2d(ggplot2::aes(fill = ..density..), 
                           geom = "raster",
                           contour = FALSE) +
  ggplot2::stat_density2d(color = 'black') +
  ...
  ggplot2::theme(legend.position = 'none',
                 ...
                 plot.title = ggplot2::element_text(size = 18, hjust = 0.5, face = "bold"))
#p_s
p_t <- ggplot2::ggplot(turns_sim, ggplot2::aes(x = abs(ang_vel), y = centr)) +
  ggplot2::stat_density_2d(ggplot2::aes(fill = ..density..), 
                           geom = "raster",
                           contour = FALSE) +
  ggplot2::stat_density2d(color = 'black') +
